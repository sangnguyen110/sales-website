...
{// These help with sign and two factor (will possibly be moved into identity framework itself)
    ...
    {
        public SignInHelper(HoangVietUserManager userManager, IAuthenticationManager authManager)
        {
            UserManager = userManager;
            AuthenticationManager = authManager;
        }

        public HoangVietUserManager UserManager { get; private set; }
        public IAuthenticationManager AuthenticationManager { get; private set; }

        public async Task SignInAsync(HoangVietUser user, bool isPersistent, bool rememberBrowser)
        {
        ...
        private async Task<SignInStatus> SignInOrTwoFactor(HoangVietUser user, bool isPersistent)
        {
