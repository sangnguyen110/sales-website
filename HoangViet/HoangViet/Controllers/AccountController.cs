...
namespace HoangViet.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(HoangVietUserManager userManager)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                ModelState.AddModelError("", "Tài khoản này đang bị khóa bởi admin, Xin liên hệ công ty để biết thêm chi tiết");
                return View(model);
            }
        ...
        public async Task<ActionResult> LoginAjax(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.Failure:
                default:
                    ModelState.AddModelError("", "Hệ thống không thể đăng nhập, xin hãy kiểm tra lại các thông tin!");
                    return PartialView("~/Views/Account/LoginPartial.cshtml", model);
            }
        }
        ...
        {
            ViewBag.CityId = new SelectList(this.Db.Citys, "Id", "CityName");
            ViewBag.DistrictId = new SelectList(this.Db.Districts, "Id", "DistrictName");
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var address = new HoangViet.Models.Common.Address {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Xác nhận mật khẩu tại website http://hoangvietgroup.net", "Hãy click vào link này để kích hoạt tài khoản tại website http://hoangvietgroup.net: <a href=\"" + callbackUrl + "\">link</a>");
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new HoangVietUser { UserName = model.Email, Email = model.Email };
